...
import org.universe.realestatebiddingsystem.app.security.jwt.JwtAuthenticationEntryPoint;
import org.universe.realestatebiddingsystem.app.security.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .antMatchers(ESTATES_URL_ALL, "/estates/{id}")
                .permitAll()
